...
function globe_config() {
    $configarray = array(
     "FriendlyName" => array("Type" => "System", "Value"=>"Globe"),
...
function globe_link($params) {
	...
	$address = $globe->getaccountaddress($params['clientdetails']['userid'].'-'.$invoiceid);
